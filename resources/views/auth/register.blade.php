        ...
        <div
            ...
            <div class="relative z-10 w-full max-w-md">
                ...
                <div class="mt-16 space-y-3">
                    <h3 class="text-white text-3xl font-bold">¡Únete a nuestra comunidad!</h3>
                    <p class="text-white">¡Crea una cuenta ahora!</p>
                    <div class="flex items-center -space-x-2 overflow-hidden">
                        ...
                        <img src="https://images.unsplash.com/photo-1510227272981-87123e259b17?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=3759e09a5b9fbe53088b23c615b6312e"
                            class="w-10 h-10 rounded-full border-2 border-white" />
                        <p class="text-sm text-white font-medium translate-x-5">Únete a nuestros usuarios</p>
                    </div>
                </div>
            </div>
            <div class="absolute inset-0 my-auto h-[500px]"></div>
        </div>
            ...
            <div class="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                <div>
                    ...
                    <div class="mt-5 space-y-2">
                        <h3 class="text-gray-800 text-2xl font-bold sm:text-3xl">Registrar</h3>
                        <p class="">¿Ya tienes una cuenta? <a href="{{ route('login') }}"
                                class="font-medium text-[#8379BE]">Iniciar sesión</a></p>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <p class="inline-block w-fit text-sm bg-white px-2 absolute -top-2 inset-x-0 mx-auto">O continua con
                    </p>
                </div>
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button type="submit"
                            class="px-4 py-2 text-white bg-[#8379BE] hover:bg-[#6f63a9] focus:ring-4 focus:outline-none focus:ring-[#6f63a9] dark:focus:ring-[#5a4f8c] transition duration-300 ease-in-out ms-4">
                            {{ __('Registrar') }}
                        </button>
                    </div>
                </form>
